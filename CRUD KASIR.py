...
def hapus_barang() :
    ...
    print("=======================================================")
    print("[1]. Hoodie Polos ", "\n[2]. Hoodie Sablon", "\n[3]. Hoodie Bordir", "\n[4]. Basic Sweater", "\n[5]. Kaos Polos", "\n[6]. Kaos Sablon", "\n[7]. Kaos Bordir")
    pilihan_hb = int(input("Masukkan Pilihan Anda : "))
    if pilihan_hb == 1 :
        print("[0]. Ukuran S", "\n[1]. Ukuran M", "\n[2]. Ukuran L", "\n[3]. Ukuran XL", "\n[4]. Ukuran XXL")
        del hoodie_polos['ukuran'][int(input("Masukkan Ukuran Yang Akan Dihapus : "))]
    elif pilihan_hb == 2 :
        print("[0]. Ukuran S", "\n[1]. Ukuran M", "\n[2]. Ukuran L", "\n[3]. Ukuran XL", "\n[4]. Ukuran XXL")
        del hoodie_sablon['ukuran'][int(input("Masukkan Ukuran Yang Akan Dihapus : "))]
    elif pilihan_hb == 3 :
        print("[0]. Ukuran S", "\n[1]. Ukuran M", "\n[2]. Ukuran L", "\n[3]. Ukuran XL", "\n[4]. Ukuran XXL")
        del hoodie_bordir['ukuran'][int(input("Masukkan Ukuran Yang Akan Dihapus : "))]
    elif pilihan_hb == 4 :
        print("[0]. Ukuran S", "\n[1]. Ukuran M", "\n[2]. Ukuran L", "\n[3]. Ukuran XL", "\n[4]. Ukuran XXL")
        del basic_sweater['ukuran'][int(input("Masukkan Ukuran Yang Akan Dihapus : "))]
    elif pilihan_hb == 5 :
        print("[0]. Ukuran S", "\n[1]. Ukuran M", "\n[2]. Ukuran L", "\n[3]. Ukuran XL", "\n[4]. Ukuran XXL")
        del kaos_polos['ukuran'][int(input("Masukkan Ukuran Yang Akan Dihapus : "))]
    elif pilihan_hb == 6 :
        print("[0]. Ukuran S", "\n[1]. Ukuran M", "\n[2]. Ukuran L", "\n[3]. Ukuran XL", "\n[4]. Ukuran XXL")
        del kaos_sablon['ukuran'][int(input("Masukkan Ukuran Yang Akan Dihapus : "))]
    elif pilihan_hb == 7 :
        print("[0]. Ukuran S", "\n[1]. Ukuran M", "\n[2]. Ukuran L", "\n[3]. Ukuran XL", "\n[4]. Ukuran XXL")
        del kaos_bordir['ukuran'][int(input("Masukkan Ukuran Yang Akan Dihapus : "))]
